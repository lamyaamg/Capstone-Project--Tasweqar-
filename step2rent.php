...
<body>
    ...
    <article class="hello" style="width: 100%;" id="2">
        ...
        <div>
            <form class="form" method="post" action="step4.php?table=<?php echo 'rent'?>" style="width: 100%;" enctype="multipart/form-data">
                ...
                <article class="reqest" style="padding-top: 0px;">
                    ...
                    <div style="display: flex; width:100%; margin-left:-90px">
                        ...
                        <div>
                            ...
                            <label>Rent frequancy<a style="color: red;">*</a></label>
                            <select class="input" name="frq" required style="width: 250px;">
                                <option selected>Yearly</option>
                                <option >Monthly</option>
                            </select>
                            <label>Rent period<a style="color: red;">*</a></label>
                            <input class="input" type="text" placeholder="0" value="0" name="rp" required style="width: 250px;">
                ...
                <div style="display: flex; width:100%">
                    ...
                    <div>
                        ...
                        <article style="display:inline-flex; padding-left:100%; padding-top:100px">
                            ...
                            <a onclick="return confirm('Are you sure you want to confirm enteries?');" href="#4"><button style="margin-left: 800px;">next</button></a>
                        </article>
                    </div>
                </div>
