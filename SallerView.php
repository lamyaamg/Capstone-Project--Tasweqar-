        ...
        <article>
            ...
            ?>
                    ...
                    <div class="image-gallery">
                        ...
                        <div class="image_overlay" style="display: flex; padding:70px;margin-top:0px; height:fit-content;  flex-direction: column; flex-wrap: nowrap; align-content: stretch; align-items:stretch; justify-content:center">
                            <div>
                                <a class="p" style="color:coral;font-size:20px; font-variant:small-caps"><?php echo $row["pro_ID"] ?> for <?php echo $row["pro_type"] ?></a><br>
                                <?php if ($row["pro_status"] == "active") { ?>
                                    <a>Property Status:</a><b><a style="color: green;"><?php echo $row["pro_status"] ?></b></a><br>
                                <?php }
                                if ($row["pro_status"] == "rejected") { ?>
                                    <a style="text-decoration:dotted" href="reson.php?propID=<?php echo $row["pro_ID"] ?>&user=<?php echo 'cus' ?>#popup" title="click to view reject reason">Property Status:</a><a><b style="color: red;"><?php echo $row["pro_status"] ?> </b> <a style="color:red; font-size:x-small">click to view</a></a><br>
                                <?php }
                                if ($row["pro_status"] == "inactive") { ?>
                                    <a>Property Status:<b style="color: red;"><?php echo $row["pro_status"] ?> </b></a><br>
                                <?php }
                                if ($row["pro_status"] == "paid") { ?>
                                    <a>Property Status:<b style="color: green;"><?php echo $row["pro_status"] ?> </b></a><br>
                                <?php } ?>


                                <a>Property Price:</a><a class="p"><?php echo $row["pro_price"] ?> SAR</a><br>
                                <a>property Category:</a><a class="p"><?php echo $row["pro_category"] ?></a><br>
                            ...
                            <div>
                                ...
                                <a> Google Map:</a><a class="p" href="<?php echo $row["Gmap"] ?>"> <?php echo $row["Gmap"] ?></a> <br>
                                <?php
                                    $pro_ID = $row["pro_ID"];
                        ...
                        <div class="info">
                            <a href="myproperties.php"><button>Back</button></a>
                        </div>
                    </div>
